...
| `novnc-desktop`             | Consumed as a GitHub-installed Ansible role in [`infra/ansible/requirements.yml`](../infra/ansible/requirements.yml) | Active operational dependency | Pin to a stable role version; see requirements.yml for the current pin                   |
